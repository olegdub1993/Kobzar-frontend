    ...
    <MainLayout title={'Kobzar ' + trackForPage?.name + "-" + trackForPage?.artist}
      ...
      <Grid container className="flex mb-8 relative text-white">
        <div className='w-[500px] h-[350px] mb-4 mt-2 '>
         { trackForPage?.picture?<Image width={500} height={350} className='rounded w-[500px] h-[350px] object-cover' alt="Track's image" src={process.env.NEXT_PUBLIC_BASIC_URL + trackForPage?.picture} />:""}
        </div>
